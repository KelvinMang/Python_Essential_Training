...
class Canvas:
    ...
    # Return format in dictionary format for write data
    def toDict(self):
        return {
            ...
            'y': self._y,
            'canvas': self._canvas,
            # scribe.toDict() is from TerminalScribe
            'scribes': [scribe.toDict() for scribe in self.scribes]
        }

    # Return format in dictionary format for read data 
    def fromDict(data):
    ...
    # Write instructions to another file
...
class TerminalScribe:
    ...
    # Store data in dictionary format for writting to file 
    def toDict(self):
        return {
            'classname': type(self).__name__,
            'color': self.color,
    ...
    # Read data from dictionary format (file)
    def fromDict(data):
...
canvas.toFile('10.Working_wif_files/solution_file')

newCanvas = Canvas.fromFile('10.Working_wif_files/solution_file')
newCanvas.go()